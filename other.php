...
$size = 0;
$total_size = 0;
$database->query("SELECT DISTINCT name FROM files WHERE type = 'other' and email = '$email' ORDER BY id DESC");
$row = $database->resultset();
$numrows = $database->rowCount();
foreach($row as $other) {
   $other = implode(' ', $other);
   $size = $categories->getFileSize('upload/music/'.$other.'');
   $total_size = $size + $total_size;
   echo "<div class='container_full_width'><div class='container highlight'><div class='row'><div class='col-md-12 text-left padd'><a href='download_document?file=".$other."'>".$other."</div></div>";
   ...
   <a href='download_other?file=".$other."'><input type='button' name='submit' class='btn btn-success' value='Download' /></a> <input type='submit' name='submit' class='btn btn-primary' value='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' /> <input type='submit' name='submit' class='btn btn-danger' value='&nbsp;&nbsp;&nbsp;Delete&nbsp;&nbsp;&nbsp;' />
   </form>
